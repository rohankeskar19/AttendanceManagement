...
public class RollNoFragmentDialog extends FragmentDialog{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_input_dialog_rollno,container,false);

        rollNoEditText = view.findViewById(R.id.edit_classroom_name);
    ...
    private void init(){
        ...
        mbtnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String input = rollNoEditText.getText().toString();
//
                if(!input.equals("")){
    ...
    public void onAttach(Context context) {
        ...
        try{
            mOnInputSelected = (RollNoFragmentDialog.OnInputListener) getActivity();
        }
