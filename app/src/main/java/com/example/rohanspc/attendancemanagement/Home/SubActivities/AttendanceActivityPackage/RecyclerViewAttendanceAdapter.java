...
public class RecyclerViewAttendanceAdapter extends RecyclerView.Adapter<RecyclerViewAttendanceAdapter.ViewHolder>{
    ...
    public RecyclerViewAttendanceAdapter(Context mContext, ArrayList<Classrooms> classrooms) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent  = new Intent(mContext,AttendanceRecieverActivity.class);
